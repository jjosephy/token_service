...
response=$(curl -s --noproxy localhost https://localhost:8443/token \
        ...
        -X POST -d '{"authType":"Mobile","applicationId":"C452AF6C-FB4B-4556-AE55-F6B08270F898","userName":"uname","password":"pwd","apiKey":"89asdfas8998asdf","mobileId":"555-555-5555","id":"95ed1aaf-e7be-419d-9584-ac0611983f06"}')
printf '\n'
echo '------------------TOKEN-------------------'
echo $response
printf '\n'
